...
class FroniusInverter:
    ...
    channelUnitDict = {"TimeSpanInSec": "sec", "Digital_PowerManagementRelay_Out_1": "1",
        ...
        "Radiation": "1", "Hybrid_Operating_State": "1"}
    ...
    def __init__(self, host):
        self.host = host
        self.baseURL = self.init_base_url()
    ...
    def init_base_url(self):
        ...
        if api_version['CompatibilityRange'] != FroniusInverter.tested_server_version:
            warnings.warn("using api version newer than last tested (" + FroniusInverter.tested_server_version + "): " + api_version[
                'CompatibilityRange'])
